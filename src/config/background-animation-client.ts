 ...
 * because ES modules are cached per URL, so the AnimatedBackground atom and
 * the AnimationSwitcher molecule importing this file share one instance)
 * and wires in the concrete registry + localStorage adapters. This is the
 * only file that knows both of those concrete pieces.
 */
